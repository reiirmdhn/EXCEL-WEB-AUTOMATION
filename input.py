...
print("Contoh Lokasi Excel : C:\..\Blabla.xlsx")
print("Contoh Lokasi Chromedriver : C:\..\CSV-Web-Automation\chromedriver.exe")
print("==================================")
...
# Sheet1 Atau Ganti dengan Nama Sheet kalian
